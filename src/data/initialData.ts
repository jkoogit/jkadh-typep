...
export const INITIAL_TASK_GRAPH: TaskGraphNode[] = [
  ...
  {
    id: 'node-plat-gitguard',
    code: 'PLAT-GITGUARD-14',
    title: 'Git 히스토리 연속성 검증 및 단절 푸시 차단기 (Anti-Orphan Guard)',
    module: 'GOVERNANCE',
    complexity: 'MEDIUM',
    estimatedTokens: 35000,
    status: 'DONE',
    dependencies: ['node-plat-secops-autohealing'],
    assignedTo: 'mem-jkoo',
    currentPhase: 7,
    riskLevel: 'LOW',
    description: '로컬 .git 인덱스 손상 및 부주의한 강제 푸시(--force)로 인한 원격 커밋 체인 소실을 사전 감지하여 차단하는 4대 방어 연속성 검증기 및 Vibe Runner 대시보드 탭 연동',
    phases: INITIAL_7_PHASES_TEMPLATE,
    gitBranch: 'task/git-continuity-guard',
    targetGitBranch: 'main',
    releaseTag: 'v2.7.0',
    targetMilestone: 'v2.7.0',
    specValidationScore: 100,
    targetRepo: 'jkadh-typep',
    migrationStatus: 'NOT_APPLICABLE',
    addedAt: '2026-08-30 07:20',
    addedReason: '원격 히스토리 단절 및 누적 이력 유실 사고 원천 방지',
  },
  {
    id: 'node-plat-workflow-designer',
    code: 'PLAT-GOV-15',
    title: '무태스크 소스수정 방지 거버넌스 가드 및 2계층 DAG 워크플로우 디자이너 편입',
    module: 'GOVERNANCE',
    complexity: 'HIGH',
    estimatedTokens: 48000,
    status: 'DONE',
    dependencies: ['node-plat-gitguard'],
    assignedTo: 'mem-jkoo',
    currentPhase: 7,
    riskLevel: 'LOW',
    description: '무태스크 소스/문서 수정 엄격 방지 거버넌스 가드 및 드래그 앤 드롭/순환참조 차단 기반 2계층 DAG 워크플로우 디자이너 정식 연동',
    phases: INITIAL_7_PHASES_TEMPLATE,
    gitBranch: 'task/task-governance-workflow-designer',
    targetGitBranch: 'main',
    releaseTag: 'v2.8.0',
    targetMilestone: 'v2.8.0',
    specValidationScore: 100,
    targetRepo: 'jkadh-typep',
    migrationStatus: 'NOT_APPLICABLE',
    addedAt: '2026-08-31 09:00',
    addedReason: '비거버넌스 임의 코드 변조 원천 방지 및 시각적 DAG 편집 인터페이스 제공',
  },
  {
    id: 'node-plat-dag-spacing-optimizer',
    code: 'PLAT-DAG-16',
    title: '작업그래프(DAG) 카드 상하·좌우 여백 조절 및 화살표 엉킴 방지 레이아웃 최적화',
    module: 'ORCHESTRATOR',
    complexity: 'MEDIUM',
    estimatedTokens: 42000,
    status: 'DONE',
    dependencies: ['node-plat-workflow-designer'],
    assignedTo: 'mem-jkoo',
    currentPhase: 7,
    riskLevel: 'LOW',
    description: 'DAG 상하(80~300px) 및 좌우(220~520px) 실시간 동적 간격 제어 슬라이더, 3단계 프리셋(조밀/표준/여유), 분산 오프셋 핀 기반 베지어 곡선 화살표 엉킴 방지 레이아웃 최적화',
    phases: INITIAL_7_PHASES_TEMPLATE,
    gitBranch: 'task/dag-spacing-and-layout-optimizer',
    targetGitBranch: 'main',
    releaseTag: 'v2.9.0',
    targetMilestone: 'v2.9.0',
    specValidationScore: 100,
    targetRepo: 'jkadh-typep',
    migrationStatus: 'NOT_APPLICABLE',
    addedAt: '2026-08-31 14:00',
    addedReason: '밀집된 노드 카드 가독성 확보 및 다중 의존선 교차 시각적 노이즈 제거',
  },
  {
    id: 'node-plat-dag-spacing-persistence',
    code: 'PLAT-DAG-17',
    title: 'DAG 간격 설정 LocalStorage 영속화 및 TaskGraphViewer 여백 동기화',
    module: 'ORCHESTRATOR',
    complexity: 'LOW',
    estimatedTokens: 28000,
    status: 'DONE',
    dependencies: ['node-plat-dag-spacing-optimizer'],
    assignedTo: 'mem-jkoo',
    currentPhase: 7,
    riskLevel: 'LOW',
    description: '브라우저 새로고침 및 세션 재진입 시에도 간격 설정이 유지되도록 LocalStorage 영속화 구축, CustomEvent 양방향 동기화 및 읽기 전용 TaskGraphViewer 여백 동기화 연동',
    phases: INITIAL_7_PHASES_TEMPLATE,
    gitBranch: 'task/dag-spacing-persistence-and-viewer-sync',
    targetGitBranch: 'main',
    releaseTag: 'v2.10.0',
    targetMilestone: 'v2.10.0',
    specValidationScore: 100,
    targetRepo: 'jkadh-typep',
    migrationStatus: 'NOT_APPLICABLE',
    addedAt: '2026-09-01 10:00',
    addedReason: '사용자 지정 간격 선호도 영구 유지 및 뷰어-디자이너 간 시각적 일관성 완비',
  },
  {
    id: 'node-plat-dag-db-sync',
    code: 'PLAT-DAG-18',
    title: '2계층 작업그래프 PostgreSQL 물리 DB 영속화 및 팀 협업 동기화 엔진',
    module: 'ORCHESTRATOR',
    complexity: 'MEDIUM',
    estimatedTokens: 35000,
    status: 'PLANNED',
    dependencies: ['node-plat-dag-spacing-persistence'],
    assignedTo: 'mem-jkoo',
    currentPhase: 1,
    riskLevel: 'LOW',
    description: '디자이너에서 편집한 작업 노드 위치 및 종속성 그래프를 PostgreSQL task_nodes / harness_tasks 테이블에 원자적 트랜잭션으로 저장하고 다중 작업자 실시간 동기화 지원',
    phases: INITIAL_7_PHASES_TEMPLATE,
    gitBranch: 'task/dag-db-persistence-sync',
    targetGitBranch: 'dev',
    specValidationScore: 90,
    targetRepo: 'jkadh-typep',
    migrationStatus: 'NOT_APPLICABLE',
    addedAt: '2026-09-06 07:00 (차기 세션 핵심 백로그)',
    addedReason: '로컬 스토리지를 넘어 팀 단위 중앙 집중형 작업그래프 영속화 및 동기화 완비',
    targetMilestone: 'v2.12.0',
  },
  {
    id: 'node-plat-dag-highlight',
    code: 'PLAT-DAG-19',
    title: 'DAG 선택 노드 연관 계통(선행·후속) 테두리 동적 하이라이트 & 캔버스 딤(Dimming) 시각화 엔진 구축',
    module: 'ORCHESTRATOR',
    complexity: 'LOW',
    estimatedTokens: 32000,
    status: 'DONE',
    ...
    currentPhase: 7,
    riskLevel: 'LOW',
    description: '노드 선택 시 선행 조상(에메랄드 링)과 후속 자손(바이올렛 링)을 실시간 재귀 탐색하여 차별화된 테두리로 강조하고, 비연관 노드 및 베지어 연결선을 딤(Dimming) 처리하여 가독성 극대화',
    phases: INITIAL_7_PHASES_TEMPLATE,
    gitBranch: 'task/dag-node-highlight-and-dimming',
    targetGitBranch: 'main',
    releaseTag: 'v2.11.0',
    targetMilestone: 'v2.11.0',
    specValidationScore: 100,
    targetRepo: 'jkadh-typep',
    migrationStatus: 'NOT_APPLICABLE',
    addedAt: '2026-09-08 06:40 (세션 0010 핵심 태스크)',
    addedReason: '복잡한 다중 노드 그래프에서 특정 노드의 인과 관계와 영향 반경을 직관적으로 식별',
  },
...
export const INITIAL_DB_TABLES: DatabaseTableMeta[] = [
  ...
  },
  {
    ...
    sampleRecords: [
      { session_code: 'SES-20260906-DAG-OPTIMIZE-13', user_id: 'jkoogi', user_email: 'jkoogit@gmail.com', status: 'COMPLETED', target_database: 'jkadhp_dev', active_task_code: 'PLAT-DAG-17', active_phase_num: 7, tokens_consumed_total: 68000 },
