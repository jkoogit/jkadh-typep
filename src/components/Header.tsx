          ...
          <div className="relative shrink-0">
            ...
            {isUserMenuOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 py-2 z-50 text-xs animate-in fade-in zoom-in-95 duration-100">
                ...
                {/* 환경변수 인식 현황 (GitHub Token & Gemini Key) */}
                <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-700/60 bg-slate-50/70 dark:bg-slate-900/40">
                  <div className="text-[11px] font-medium text-slate-500 dark:text-slate-400 mb-1.5 flex items-center justify-between">
                    <span>필수 환경변수 인식 상태</span>
                    <span className="w-2 h-2 rounded-full bg-emerald-500 shrink-0" title="모든 필수 환경변수 정상" />
                  </div>
                  <div className="space-y-1 font-mono text-[10px]">
                    <div className="flex items-center justify-between text-slate-700 dark:text-slate-300">
                      ...
                      <span className="text-emerald-600 dark:text-emerald-400 font-semibold">@jkoogit (연결됨)</span>
                    </div>
                    <div className="flex items-center justify-between text-slate-700 dark:text-slate-300">
                      <span className="flex items-center gap-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
